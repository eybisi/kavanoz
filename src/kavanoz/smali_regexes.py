...
class Regexs:
    ...
    def set_first_inner_regex(self, rc4_string_var: str):
        ...
        first_inner_2 = r"invoke-static L[^;]+;->([^\(]+)\(\w*\)+Ljava/lang/StringBuilder;\s+" \
        ...
        first_inner_6 = r"invoke-static [vp]\d+, L[^;]+;->([^\(]+)\(\w*\)+Ljava/lang/StringBuilder;\s+" \
            r"move-result-object [vp]\d+\s+" \
            r"invoke-static [vp]\d+, Ljava/lang/String;->valueOf\(Ljava/lang/Object;\)Ljava/lang/String;\s+" \
            r"move-result-object [vp]\d+\s+" \
            fr"iput-object [vp]\d+, [vp]\d+, L[^;]+;->{rc4_string_var} Ljava/lang/String;"
        first_inner_9 = r"invoke-static L[^;]+;->([^\(]+)\(\)+Ljava/lang/StringBuilder;\s+" \
            r"move-result-object [vp]\d+\s+" \
        ...
        first_inner_3 = "invoke-static L[^;]+;->([^\(]+)\(\w*\)Ljava\/lang\/String;\s+" \
            "move-result-object [vp]\d+\s+" \
            f"iput-object [vp]\d+, [vp]\d+, L[^;]+;->{rc4_string_var} Ljava/lang/String;"

        first_inner_7 = "invoke-static [vp]\d+, L[^;]+;->([^\(]+)\(Ljava/lang/String;\)Ljava\/lang\/String;\s+" \
            "move-result-object [vp]\d+\s+" \
            f"iput-object [vp]\d+, [vp]\d+, L[^;]+;->{rc4_string_var} Ljava/lang/String;"
        first_inner_10 = r"invoke-static [vp]\d+, L[^;]+;->([^\(]+)\(\[I\)Ljava\/lang\/String;\s+" \
            "move-result-object [vp]\d+\s+" \
            f"iput-object [vp]\d+, [vp]\d+, L[^;]+;->{rc4_string_var} Ljava/lang/String;"
        ...
        first_inner_11 = r"invoke-static [vp]\d+, L[^;]+;->([^\(]+)\(\[Ljava/lang/String;\)Ljava\/lang\/String;\s+" \
            r"move-result-object [vp]\d+\s+" \
        ...
        first_inner_4 = r"invoke-static [vp]\d+, L[^;]+;->([^\(]+)\(Ljava/lang/Object\)Ljava/lang/StringBuffer;\s+" \
            r"move-result-object [vp]\d+\s+" \
        ...
        first_inner_5 = r"invoke-static L[^;]+;->([^\(]+)\(\)Ljava/lang/StringBuffer;\s+" \
            r"move-result-object [vp]\d+\s+" \
            r"invoke-virtual [vp]\d+, Ljava/lang/StringBuffer;->toString\(\)Ljava/lang/String;\s+" \
            r"move-result-object [vp]\d+\s+" \
            fr"iput-object [vp]\d+, [vp]\d+, L[^;]+;->{rc4_string_var} Ljava/lang/String;"
        ...
        first_inner_8 = r"invoke-static [vp]\d+, L[^;]+;->([^\(]+)\(Z\)Ljava/lang/StringBuilder;\s+" \
            r"move-result-object [vp]\d+\s+" \
            r"invoke-virtual [vp]\d+, Ljava/lang/StringBuilder;->toString\(\)Ljava/lang/String;\s+" \
            r"move-result-object [vp]\d+\s+" \
            fr"iput-object [vp]\d+, [vp]\d+, L[^;]+;->{rc4_string_var} Ljava/lang/String;"
